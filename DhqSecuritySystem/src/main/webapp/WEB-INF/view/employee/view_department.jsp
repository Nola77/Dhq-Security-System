...
<head>
  ...
  <title>Security Admin - View Visitor</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800" id="department_update_text">View visitor</h1>
          <br>
          ...
          <form class="was-validated" action="department" method="POST">
            <div class="form-row">
               ...
               <input type="text" class="form-control" id="department_name" name="name" value="${department.departmentName}" readonly="readonly" required>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3 mt-4">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="department_email" name="departmentEmail" value="${department.departmentEmail}"  readonly="readonly" required>
                  <div class="invalid-tooltip">
                    Please Enter Cid.
                  </div>
                  <div class="valid-tooltip">
