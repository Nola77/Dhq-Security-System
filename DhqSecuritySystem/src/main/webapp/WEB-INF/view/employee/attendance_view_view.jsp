...
<head>
  ...
  <title>Security - Add CheckIn</title>
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
         ...
         <!-- Begin Page Content -->
           ...
           <!-- Page Heading -->
           <h1 class="h3 mb-2 text-gray-800" id="employee_update_text">Add CheckIn</h1>
           <br>

           <form class="was-validated" action="attendance" method="POST">
           <div class="form-row">
           ...
           <input type="text" class="form-control" id="lastName" name="lastName" value="${employee.lastName}" readonly="readonly" required>
            ...
            Looks good!
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-3 mb-3 mt-4">
                       <label for="validationTooltipDesignation">DID</label>
                        <input type="text" class="form-control" name="designation" id="designation" value="${employee.designation}" readonly="readonly"  required>
                         <div class="invalid-tooltip">
                    ...
                    <button class="btn btn-primary mt-4 mb-4" type="submit" id="add_btn">CheckIn</button>
                  </form>
