...
<head>
  ...
  <title>Security Admin - View Staff</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800" id="employee_update_text">View Staff</h1>
          <br>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-4 mt-4">
               <label for="validationTooltipDesignation">DID</label>
                <input type="text" class="form-control" name="designation" id="designation" value="${employee.designation}" disabled="disabled"  required>
                <div class="invalid-tooltip">
                 Please provide DID.
                </div>
                <div class="valid-tooltip">
              ...
              <div class="col-md-3 mb-4 mt-4">
                ...
                <input type="date" class="form-control" id="birthday" name="birthday" value="${employee.birthday}" readonly="readonly"  required>
                <div class="invalid-tooltip">
              ...
              <div class="col-md-3 mb-4 mt-4">
                ...
                <input type="date" class="form-control" id="joinedDate" name="joinedDate" value="${employee.joinedDate}" readonly="readonly">
                <div class="invalid-tooltip">
