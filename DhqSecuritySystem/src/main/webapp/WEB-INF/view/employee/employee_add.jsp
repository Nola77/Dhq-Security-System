...
<head>
  ...
  <title>Security Admin - Add Staff</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Security Admin</div>
      </a>
...
<!-- Heading -->
      ...
      <hr class="sidebar-divider d-none d-md-block">
       ...
       <!-- Nav Item -Attendance List -->
        <li class="nav-item">
         <a class="nav-link" href="/admin/attendance-datatable">
         <i class="fas fa-list"></i>
          ...
          <form:form action="employee" class="was-validated" >
            ...
            <div class="form-row">
              ...
              <div class="col-md-3 mb-3 mt-4">
                ...
                <input type="text" class="form-control" name="nic" placeholder="CID" required>
                <div class="invalid-tooltip">
              ...
              <div class="col-md-3 mb-3 mt-4">
                ...
                <input type="text" class="form-control" name="designation" placeholder="DID" required>
                 <div class="invalid-tooltip">
              ...
              <div class="col-md-6 mb-4 mt-4">
                <label for="validationTooltipDesignation">Marital Status</label>
                ...
                <div class="col-md-6 mb-4 mt-4">
                  <label for="validationTooltipDesignation">Department</label>
                    <select class="custom-select" id="normal_emp_add_department" name="department" required>
                      ...
                      <option value="Desuung Skilling Programme">Desuung Skilling Programme</option>
                      <option value="Tranning Department">Tranning Department</option>
                      <option value="Service Pin">Service Pin</option>
                      <option value="Dessung Fire Service">Dessung Fire Service</option>
            ...
            <button class="btn btn-primary mt-4 mb-4" type="submit" id="add_btn">Add Staff</button>
